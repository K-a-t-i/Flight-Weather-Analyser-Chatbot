...
METEOBLUE_API_KEY = get_env_variable("METEOBLUE_API_KEY", required=True)
OPENCAGE_API_KEY = get_env_variable("OPENCAGE_API_KEY", required=True)
VISUALCROSSING_API_KEY = get_env_variable("VISUALCROSSING_API_KEY", required=True)

# API keys dictionary for WeatherService
API_KEYS = {
    "openai": OPENAI_API_KEY,
    "meteoblue": METEOBLUE_API_KEY,
...
# Set up cache configuration for passing to WeatherService
CACHE_CONFIG = {
...
try:
    ...
    weather_service = WeatherService(API_KEYS, CACHE_CONFIG)
    logger.info("Successfully initialized WeatherService")
